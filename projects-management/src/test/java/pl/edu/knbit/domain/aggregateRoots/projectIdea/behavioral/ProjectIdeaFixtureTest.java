package pl.edu.knbit.domain.aggregateRoots.projectIdea.behavioral;

import org.axonframework.test.FixtureConfiguration;
import org.axonframework.test.Fixtures;
import org.junit.Before;
import org.junit.Test;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.ProjectIdea;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.commands.AcceptTeamLeaderCommand;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.commands.OpenTeamLeaderRecruitmentCommand;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.entities.MemberID;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.events.*;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.handlers.ProjectIdeaCommandHandler;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.valueObjects.ProjectIdeaID;
import pl.edu.knbit.domain.aggregateRoots.projectIdea.valueObjects.TeamLeaderRecruitmentStatus;
